...
% Formatting
\hypersetup{colorlinks= true, linkcolor=blue(pigment)}
\spanishdecimal{.}
\tolerance=1000
\hyphenpenalty=1000
...
\begin{art}\label{}% TODO Mover a vacancias.
...
\begin{art}\label{funcionesPresidente}
	...
	\end{enumerate}% ? Añadir la posibilidad de agregar cargos opcionales de la forma que mencionan los estatutos del CAi, en el artículo 6.A(4)
\end{art}
...
\begin{art}\label{eleccionesConsejeriaFalla}
	Si al final del plazo de inscripción no hay postulaciones, se agregará un plazo extraordinario a lo más de cinco días hábiles. En caso de no haber una postulación en este plazo extraordinario, el vicepresidente interno tomará el rol de Consejero Académico. % TODO Discutir la última frase
\end{art}
...
\begin{art}\label{eleccionesDelegadosCandidatos}
	Todo estudiante de la Facultad de Matemáticas podrá postularse a ser Delegado de su generación. La elección se conformará de votaciones por generación. Entendiéndose generación de la forma descrita en el artículo \ref{definicionesOrganismos}.% ? refrasear
\end{art}
...
% TODO Rellenar con las especificaciones bajo las cuales se pierde un cargo, o es destituido por el Consejo Estudiantils
\begin{art}\label{}
    Cualquier miembro de la Directiva puede ser destituido por acuerdo de la Asamblea General, con la aprobación de la mayoría absoluta de ésta, siempre y cuando dicha asamblea tenga una asistencia mayor o igual al 35\% de los estudiantes de la Facultad. En caso contrario, será necesario hacer un plebiscito.
\end{art}
...
\begin{art}\label{vacanciasDirectiva}
...
% \begin{art}\label{vacanciasPresidente}

% \end{art}

% \begin{art}\label{vacanciasVicepresidenteInterno}

% \end{art}

% \begin{art}\label{vacanciasVicepresidenteExterno}

% \end{art}

% \begin{art}\label{vacanciasSecretario}

% \end{art}

% \begin{art}\label{vacanciasTesorero}

% \end{art}

% \begin{art}\label{vacanciasConsejeria}
...
% Agregar la posibilidad de votaciones online bajo varias restricciones: \/
% TODO Revisar el estatuto de ciencia política
% TODO Agregar consulta publica
% Posible articulo: Van a haber votaciones vinculantes y no vinculantes, estás últimas son consultas publicas.
