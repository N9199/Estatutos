...
\begin{art}\label{funcionesVicepresidenciaExterno}
    ...
    \begin{enumerate}
        ...
        \item Subrogar a quien tenga el cargo de la Vicepresidencia Interna en caso de ausencia de este.
...
\begin{art}\label{funcionesSecretaria}
    Son funciones de quien esté a cargo de la Secretaría General:
    \begin{enumerate}
...
\begin{art}\label{funcionesTesoreria}
    ...
    \begin{enumerate}
        \item Llevar la contabilidad del CAM, entendiéndose como mantener el libro de ingresos y egresos al día, mantener todas la boletas del CAM y todo lo que compruebe las cuentas realizadas. Tener la contabilidad del CAM a disposición de todo estudiante representado.
...
\begin{art}\label{funcionesDelegados}
    ...
    \begin{enumerate}
        ...
        \item Difundir, con debida anticipación, las convocatorias de los Consejos Estudiantiles.
    \end{enumerate}
\end{art}
...
\begin{art}\label{eleccionesDirectivaPublicacion}
    Al término del proceso de inscripción quien tenga el cargo de la Secretaría General deberá publicar en los medios oficiales las listas de candidatos y sus respectivos programas.
\end{art}
...
\begin{art}\label{eleccionesDelegadosPostulacionFalla}
    Si en alguna generación no exista una postulación, quien tenga el cargo de la Secretaría General deberá suplir las funciones del Delegado correspondiente hasta que la Directiva asigne algún representante.
\end{art}

\begin{art}\label{eleccionesDelegadosFalla}
    Si en alguna generación se rechazan todas las postulaciones, el puesto quedará vacante, y se seguirá lo descrito en el artículo \ref{vacanciasConsejoDelegados}.
\end{art}
...
\begin{art}\label{vacanciasDirectivaMiembro}
    ...
    \begin{enumerate}
        \item Si el cargo es ejecutivo (i.e. Presidencia, Vicepresidencia Interna, Vicepresidencia Externa) este será reemplazado por el siguiente cargo ejecutivo en la línea de sucesión, la cual por defecto será, en orden, Presidencia, Vicepresidencia Interna y por último Vicepresidencia Externa.
        \item Si el cargo es administrativo (i.e. Secretaría, Tesorería) este será reemplazado por el siguiente cargo administrativo en la línea de sucesión, la cual por defecto será, en orden, Secretaría y por último Tesorería.
