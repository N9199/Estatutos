...
\begin{art}\label{}
    Los organismos del CAM que no son directivos son os siguientes:
    \begin{enumerate}
        \item TRICEL: Está conformado por estudiantes epresentados como se describe en la sección \ref{TRICEL}.
    \end{enumerate}
\end{art}
