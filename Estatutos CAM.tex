...
\begin{art}\label{eleccionesDirectivaPublicacion}
    Al término del proceso de inscripción, Secretaría General deberá publicar en los medios oficiales las listas de candidatos y sus respectivos programas.
\end{art}
...
\begin{art}\label{eleccionesDelegadosCandidatos}
    Todo estudiante representado podrá postularse a ser Delegado del grupo que le corresponda, dentro de los mencionados en el articulo \ref{organismosDirectivos} punto iii. Las votaciones se llevarán a cabo como se describe en la subsección \ref{votacionesDelegados}.
\end{art}
