...
\begin{art}\label{atribucionesEstudiantes}
    ...
    \begin{enumerate}
        ...
        \item Proponer proyectos a la Directiva.
        ...
        \item Consejo de Delegados: Se conformará por los delegados de cada generación de cada carrera, un delegado de Postgrado y un delegado correspondiente a todos los estudiantes no considerados en los grupos anteriores. Hay cinco generaciones Estadística y cuatro de Matemáticas, se dividen como se ve en la tabla.
              \begin{center}
                  \begin{tabular}{|c|c|c|}
                      ...
                      \hline
                  \end{tabular}
              \end{center} % TODO Nombres de generación? 
...
\begin{art}\label{}
    ...
    \begin{enumerate}
        ...
        \item Al tener dos o más alertas (sistema de permanencia). % * Relacionado con eleccionesCAMCandidatos
    \end{enumerate} % TODO Mover a Destituciones Renuncias y Vacancias? % TODO Agregar que para postular se necesita no cumplir cualquiera de las anteriores en de la elección de cargos
\end{art}
...
\begin{art}\label{funcionesDirectiva}
    ...
    \begin{enumerate}
        ...
        \item Convocar a sesiones ordinarias y extraordinarias de la Asamblea General. % ? Revisar con respecto a lo escrito en la sección de Asambleas Generales
...
\begin{art}\label{funcionesConsejoEstudiantil}
    ...
    \begin{enumerate}
        ...
        \item En caso de que el Consejo lo estime necesario, destituir a cualquier miembro de un organismo directivo del CAM. Esto se regirá según lo descrito en el artículo \ref{destituciones} en la sección \ref{vacancias}
    \end{enumerate}
\end{art}
...
\begin{art}\label{eleccionesCAMInscripcion}
    Si una vez cumplido el plazo de inscripción no hay postulaciones, el Consejo Estudiantil decidirá si agregará un plazo extraordinario a lo más de cinco días hábiles o designar una Directiva interina.
\end{art}
...
\begin{art}\label{eleccionesCAMCandidatos}
    Sólo podrán ser candidatos a los cargos de la Directiva aquellos estudiantes de pregrado que sean integrantes de la Facultad de Matemáticas y que tengan a lo más una alerta (sistema de permanencia). % TODO discutir si son una o dos alertas
\end{art}
...
% TODO revisar si requiere restricciones de notas o algo?
% TODO revisar si hay algo a cambiar sobre la postulación en lista?

\begin{art}\label{eleccionesConsejeriaLista}
    Cada postulación a la Consejería Académica será conformada por un Consejero Académico y un Subconsejero Académico.
\end{art}
...
\begin{art}\label{TRICELFunciones}
    ...
    \begin{enumerate}
        ...
        \item Conocer la cualquier asunto relacionado con las votaciones que fiscalice.
        ...
        \item Determinar, publicar y distribuir el material necesario para la implementación de las votaciones.
    \end{enumerate}
\end{art}
...
\begin{art}\label{destitucionesConsejo}
    El Consejo Estudiantil puede destituir miembros del CAM si es que este así lo decide por una votación interna.
\end{art}
...
\subsection{Vacancias y Renuncias}\label{vacancias}

\begin{art}\label{renunicasGeneral}
...
\begin{art}\label{vacanciasDirectivaMiembro}
    ...
    \begin{enumerate}
        ...
        \item Si el cargo es administrativo (i.e. Tesorero, Secretario) este será reemplazado por el siguiente cargo administrativo en la línea de sucesión, la cual por defecto será, en orden, Tesorero y por último Secretario.
