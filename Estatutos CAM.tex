...
\begin{art}\label{deberesDirectiva}
    ...
    \begin{enumerate}
        ...
        \item Apoyar a las vocalías\footnote{Como se definen en la sección \ref{vocalias}}.%4
...
\begin{art}\label{atribucionesDirectiva}
    ...
    \begin{enumerate}
        \item Convocar a sesiones extraordinarias de Asambleas Generales\footnote{Como se describe en el artículo \ref{asambleas}}.%8
...
\begin{art}\label{funcionesVicepresidenteExterno}
    ...
    \begin{enumerate}
        ...
        \item Subrogar al Vicepresidente Interno en su ausencia.
...
\begin{art}\label{eleccionesDelegadosCandidatos}
    Todo estudiante representado podrá postularse a ser Delegado del grupo que le corresponda, dentro de los mencionados en el artículo \ref{normasGenerales} punto iii. Las votaciones se llevarán a cabo como se describe en la subsección \ref{votacionesDelegados}.
\end{art}
...
\begin{art}\label{perdidaCargosCAM}
    ...
    \begin{enumerate}
        \item Renuncia voluntaria. %1
        \item Destitución por medios definidos en la sección \ref{destituciones} %2
        \item Abandono de la carrera, en caso de ser Delegado o Consejero Académico.
        \item Suspensión de la carrera de forma voluntaria y temporal. %5
    \end{enumerate}
\end{art}
...
\begin{art}\label{vacanciasDirectivaMiembro}
    ...
    \begin{enumerate}
        \item Si el cargo es ejecutivo (i.e. Presidente, Vicepresidente Interno, Vicepresidente Externo) este será reemplazado por el siguiente cargo ejecutivo en la cadena de mando, la cual por defecto será, en orden, Presidente, Vicepresidente Interno y por último Vicepresidente Externo.
        \item Si el cargo es administrativo (i.e. Secretario, Tesorero) este será reemplazado por el siguiente cargo administrativo en la cadena de mando, la cual por defecto será, en orden, Secretario y por último Tesorero.
